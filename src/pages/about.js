  ...
  <Layout>
    ...
    <div className={styles.container}>
      ...
      <p>
        ...
        new technologies, tools and languages. I mostly blog abut programming
        related topics but occasionally write about other topics such as
        personal finance, and health and fitness.
      </p>
      ...
      <p className={styles.para}>
        ...
        introduction to computers. It covered several areas including software,
        hardware, networking, programming, and theoretical computer science. The
        programming section was taught using{" "}
        <a href="https://en.wikipedia.org/wiki/Karel_(programming_language)">
          Karel the Robot
        </a>
        ...
        some point during first year I realized people actually get paid to do
        this and decided to make computer science my major.
      </p>
      ...
      <p className={styles.para}>
        ...
        <a href="https://en.wikipedia.org/wiki/Big_O_notation">Big O</a>{" "}
        ...
        keep a large codebase organized, and reproduce a pdf design from
        Photoshop in HTML and CSS with pixel perfection on all browsers prior to
        box model standardization. Fortunately I had several wonderful mentors
        to guide me through the on-the-job learning process.
      </p>
