...
What I want is for more patients, caregivers, and researchers facing cancer to hear about one idea and take it seriously: that cancer may have a metabolic dimension, maybe even a root cause that the genetic paradigm has missed, and that this may be why cures built on genetics remain so elusive. Taking it seriously means two things: know what's already shown safe today, and keep pushing for the rest to be properly tested.
