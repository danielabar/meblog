...
Here is the `UsersController` generated by the Rails [scaffold](https://www.rubyguides.com/2020/03/rails-scaffolding/) command `bin/rails g scaffold User name:string email:string:uniq`:
